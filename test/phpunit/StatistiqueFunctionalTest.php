...
/**
 * \file    test/phpunit/StatistiqueFunctionalTest.php
 * \ingroup statistique
...
/**
 * Class StatistiqueFunctionalTest
 *
 ...
 *
 * @package Teststatistique
 */
class StatistiqueFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modStatistique')->click();
		} else {
			// Disable the module
			$this->byHref('modStatistique')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/statistique/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('statistique/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/statistique/admin/about.php');
		$this->authenticate();
		return $this->assertContains('statistique/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('statistiquewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modStatistique_StatistiqueTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modStatistique_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
