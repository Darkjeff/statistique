...
/**
 *	\file       statistique/statistiqueindex.php
 *	\ingroup    statistique
 *	\brief      Home page of statistique top menu
 */
...
$langs->loadLangs(array("statistique@statistique"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->statistique->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("StatistiqueArea"));

print load_fiche_titre($langs->trans("StatistiqueArea"), '', 'statistique.png@statistique');
...
// Draft MyObject
if (! empty($conf->statistique->enabled) && $user->rights->statistique->read)
{
	$langs->load("orders");
